...
DigitalInput* RobotMap::launcherWinchDownSwitch = NULL;
DigitalInput* RobotMap::launcherWinchUpSwitch = NULL;
AnalogChannel* RobotMap::launcherBallSensor = NULL;
SpeedController* RobotMap::launcherWinchMotors = NULL;
...
void RobotMap::init() {
	...
	armRollerBar = new Talon(1, 3);
	lw->AddActuator("Arm", "Roller Bar", (Talon*) armRollerBar);
	
	launcherWinchDownSwitch = new DigitalInput(1, 5);
	lw->AddSensor("Launcher", "Winch Down Switch", launcherWinchDownSwitch);
	...
	launcherWinchMotors = new Talon(1, 4);
	lw->AddActuator("Launcher", "Winch Motors", (Talon*) launcherWinchMotors);
